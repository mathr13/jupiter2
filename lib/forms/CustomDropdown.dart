      ...
      child: Column(
        ...
        children: <Widget>[
          new Container(
              ...
              child: new FutureBuilder(
                  ...
                  builder:
                    ...
                    if (!snapshot.hasData)
                      return new Text(widget.item['label'],
                          style: new TextStyle(
          ...
          FutureBuilder<List<dynamic>>(
              future: db.fetchDataSourceData(
                  widget.formItems[widget.count]['dataSource']),
                ...
                return DropdownButton<dynamic>(
                  ...
                  items: snapshot.data
                      ...
                      .map((dynamic value) => DropdownMenuItem<dynamic>(
                            child: Text(value[widget.formItems[widget.count]
                                    ['dataSource'][0]['displayMember']]
                                .toString()),
                            value: value[widget.formItems[widget.count]
                    ...
                    setState(() {
                      {
                        ...
                        listOfHierarchy[0]['${widget.item['nodeHierarchy']}']
                            .first
                            .addAll(
